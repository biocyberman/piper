...
then
	...
	GATK_BUNDLE_B37="/space/data/resources/gatk/2.8/b37"
...
then
	...
	JOB_RUNNER=" Shell"
	JOB_NATIVE_ARGS=""
	PATH_TO_BWA="/usr/local/bin/bwa"
	PATH_TO_SAMTOOLS="/usr/local/bin/samtools"
	PATH_TO_RNA_SEQ_QC="/space/system/piper_resources/RNA-SeQC_v1.1.7.jar"
	PATH_TO_TOPHAT="/usr/local/bin/tophat2"
	PATH_TO_CUTADAPT="/usr/local/bin/cutadapt"
	PATH_TO_CUFFLINKS="/usr/bin/cufflinks"
    PATH_TO_CUFFDIFF="/usr/bin/cuffdiff"
	PATH_TO_SYNC_CUTADAPT="/space/system/piper_resources/FixEmptyReads.pl"
	PATH_TO_QUALIMAP="/usr/local/bin/qualimap"
	GATK_BUNDLE_B37="/space/data/resources/gatk/2.8/b37"
	GATK_BUNDLE_HG19="/space/data/resources/gatk/2.8/b37"
fi
...
DB_SNP_B37=${GATK_BUNDLE_B37}"/dbsnp_138.b37.vcf.gz"
MILLS_B37=${GATK_BUNDLE_B37}"/Mills_and_1000G_gold_standard.indels.b37.vcf.gz"
ONE_K_G_B37=${GATK_BUNDLE_B37}"/1000G_phase1.indels.b37.vcf.gz"
HAPMAP_B37=${GATK_BUNDLE_B37}"/hapmap_3.3.b37.vcf.gz"
OMNI_B37=${GATK_BUNDLE_B37}"/1000G_omni2.5.b37.vcf.gz"
MILLS_B37=${GATK_BUNDLE_B37}"/Mills_and_1000G_gold_standard.indels.b37.vcf.gz"
THOUSAND_GENOMES_B37=${GATK_BUNDLE_B37}"/1000G_phase1.snps.high_confidence.b37.vcf.gz"

DB_SNP_HG19=${GATK_BUNDLE_H19}"/dbsnp_138.hg19.vcf.gz"
MILLS_HG19=${GATK_BUNDLE_H19}"/Mills_and_1000G_gold_standard.indels.hg19.vcf.gz"
ONE_K_G_HG19=${GATK_BUNDLE_H19}"/1000G_phase1.indels.hg19.vcf.gz"
HAPMAP_H19=${GATK_BUNDLE_HG19}"/hapmap_3.3.hg19.vcf.gz"
OMNI_HG19=${GATK_BUNDLE_HG19}"/1000G_omni2.5.hg19.vcf.gz"
MILLS_HG19=${GATK_BUNDLE_HG19}"/Mills_and_1000G_gold_standard.indels.hg19.vcf.gz"
THOUSAND_GENOMES_HG19=${GATK_BUNDLE_HG19}"/1000G_phase1.snps.high_confidence.hg19.vcf.gz"
