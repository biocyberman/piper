...
import molmed.utils.{AlignmentUtilsBwa, GeneralUtils}
...
class AlignWithBWA extends QScript with UppmaxXMLConfiguration {
  ...
  def script() {
    ...
    val alignmentHelper = new AlignmentUtilsBwa(this, bwaPath, bwaThreads, samtoolsPath, projectName, uppmaxConfig)
